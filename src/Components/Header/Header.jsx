        ...
        <header className={`w-full ${Size ? 'h-[15vh]' : 'h-[8.5vh]'} lg:h-[15vh] flex justify-center flex-wrap lg:pr-6 fixed lg:relative shadow-lg lg:shadow-none z-50 bg-white lg:bg-transparent overflow-hidden`}>
            <div className={`w-full lg:h-full ${Size ? 'h-1/2' : 'h-full'} flex px-2 lg:px-0 pr-5 lg:pr-0`}>
                ...
                <div className="lg:w-4/6 xl:w-1/2 h-full lg:flex justify-end items-center hidden">
                    <ul className={`h-full flex justify-end items-center gap-6 text-[1.1rem] text-${Props.color}`}>
                        ...
                        <div className="h-full flex items-center gap-3">
                            ...
                            <Link to="/Register" className={`px-6 py-2 border border-${Props.color} text-${Props.color} rounded-full link hover:bg-black hover:text-white`}>Register</Link>
                        </div>
                    </ul>
                </div>
