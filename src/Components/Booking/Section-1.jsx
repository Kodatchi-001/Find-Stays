...
export default function Section_1() {
    ...
    useEffect(() => {
        setinputnumber(liste[liste.length - 1]?.Person || 0)
        setinputCheckin(liste[liste.length - 1]?.DateIn || '')
        setinputCheckout(liste[liste.length - 1]?.DateOut || '')
                        ...
                        <div key={index} className="w-full h-full flex flex-wrap gap-5">
                            ...
                            <div className="w-full h-full lg:h-screen py-2 flex justify-between flex-wrap">
                                <div className="w-full lg:w-[65%] h-full flex flex-col justify-between">
                                    <div className="w-full h-[40vh] lg:h-[70%] rounded-3xl cards-homepage" style={{ backgroundImage: `url(${require(`../../Assets/${items.img}`)})` }}>
                                    ...
                                    <div className="w-full h-[30%] flex justify-between items-center py-4 lg:py-2 gap-2 lg:gap-0 overflow-x-scroll lg:overflow-auto">
                                        <div className="min-w-[40vw] lg:min-w-[24%] h-[15vh] lg:h-[80%] rounded-xl lg:rounded-3xl cursor-pointer cards" style={{ backgroundImage: `url(${require(`../../Assets/${items.img}`)})` }}></div>
                                        <div className="min-w-[40vw] lg:min-w-[24%] h-[15vh] lg:h-[80%] rounded-xl lg:rounded-3xl cursor-pointer cards" style={{ backgroundImage: `url(${require(`../../Assets/${items.img_2}`)})` }}></div>
                                        <div className="min-w-[40vw] lg:min-w-[24%] h-[15vh] lg:h-[80%] rounded-xl lg:rounded-3xl cursor-pointer cards" style={{ backgroundImage: `url(${require(`../../Assets/${items.img_3}`)})` }}></div>
                                        <div className="min-w-[40] lg:min-w-[24%] h-[15vh] lg:h-[80%] rounded-xl lg:rounded-3xl cursor-pointer cards" style={{ backgroundImage: `url(${require(`../../Assets/${items.img_4}`)})` }}></div>
                                    </div>
                                </div>
                                    ...
                                    <div className="w-full lg:h-[72%] flex flex-col justify-between p-4 rounded-xl bg-white">
                                        ...
                                        <div className="w-full flex flex-wrap gap-2">
                                            ...
                                            <div className="w-full flex justify-end items-center relative">
                                                ...
                                                <div className="w-1/2 h-5/6 flex justify-end items-center gap-1 px-3 rounded-full absolute mr-2 bg-white">
                                                    <i class='bx bx-minus p-2 scale-90 cursor-pointer bg-gray-200 rounded-full border border-black'
                                                        onClick={e => setinputnumber( e.target.value >= 0 ? inputnumber - 1 : 0)}></i>
